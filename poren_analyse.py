...
def image_detection(pic, threshold_value, opening=True, dilation=True):
    ...
    cv2.putText(contour_pic, text1, (10, 70), font, 2, (0, 255, 0), 4, cv2.LINE_AA)
    cv2.putText(contour_pic, text2, (10, 140), font, 2, (0, 255, 0), 4, cv2.LINE_AA)
...
class PictureImporter:
    def __init__(self, master):
        ...
        self.threshold_slider = tk.Scale(self.frame, from_=20, to=100, orient="horizontal", length=160,
